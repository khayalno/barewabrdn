...
# ٢. دانانی پەیامی بەخێرهاتن لە چاتی تایبەت (بێ ڕستە زیادەکان)
...
def tag_all(message):
    ...
    if message.chat.type in ['group', 'supergroup']:
        try:
            # پشکنین بۆ ئەوەی بزانین ئایا بەکارهێنەرەکە ئەدمینە یان نا
            ...
            bot.reply_to(message, "⚠️ هەڵەیەک ڕوودا لە پشکنینی ئەدمین.")
